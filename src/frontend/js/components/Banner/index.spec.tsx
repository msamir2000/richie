...
describe('Banner', () => {
  ...
  it('supports a rounded boolean property', () => {
    const { container } = render(
      <Banner type={BannerType.INFO} message="A message for test purpose" rounded />,
    );
    const $banner = container.querySelector('.banner.banner--rounded');
